...
public class Solution {
    ...
    public static void printMatrix(Integer m, Double n, Double value) {
    }
    public static void printMatrix(Double m, Double n, Double value) {
    }
    public static void printMatrix(Double m, float n, Double value) {
    }
    public static void printMatrix(Double m, float n, Solution value) {
    }
}
